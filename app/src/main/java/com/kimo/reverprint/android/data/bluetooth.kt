...
class AndroidBluetoothLeController(private val context: Context) : BluetoothLeController {
    ...
    private var txCharacteristic: BluetoothLeCharacteristic? = null
    private var rxCharacteristic: BluetoothLeCharacteristic? = null

    override fun setReadCharacteristic(rxCharacteristic: BluetoothLeCharacteristic?) {
        this.rxCharacteristic = rxCharacteristic
    }

    override fun setWriteCharacteristic(txCharacteristic: BluetoothLeCharacteristic?) {
